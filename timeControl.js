...
export function timeControl(svg) {
  ...
  // 向右滚动按钮事件处理器
          ...
          console.log("initializeOrUpdateChart222222222222222222222222222");
          break;
        case 'month':
          // 定义40天时间段的开始和结束日期
          startDate = new Date();
        ...
        function monthdrawAxis() {
          ...
          console.log("initializeOrUpdateChart222222222222222222");
          break;
        case 'quarter':
          // 设置开始和结束日期以覆盖半年的时间
          const today = new Date();
        ...
        function drawAxis() {
          ...
          console.log("initializeOrUpdateChart2222222222222222");
          break;
      }
    ...
    console.log("initializeOrUpdateChart22222222222222222222222222211111111111111");
